...
public class Manager {
    ...
    -> nhập không đúng -> yêu cầu người dùng nhập lại
    -> nhập đúng -> name không có trong list -> hiển thị ra màn hình " Not Existed Student" 
    -> có trong list -> hiển thị ra danh sách học sinh dựa theo tên được tìm kiếm -> hiển thị cái danh sách đã được sort by name 
    */
    ...
    public Student searchStudentByID(List<Student>list,String id_to_find){
        //loop access from first stuent to last student in list
        for(Student s: list){
      ...
      public void updateStudent(Student findedStudent,ArrayList<Student>list){
        //show information student before update
          System.out.println("date student before update: ");
    ...
    public void difplayReport(ArrayList<Student> studentList){
